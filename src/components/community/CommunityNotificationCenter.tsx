...
import { Bell, X, CheckCircle, AlertTriangle, Clock, Users, Heart, Award } from 'lucide-react'
...
export const CommunityNotificationCenter = () => {
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    // Set up real-time subscription for community notifications
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newNotification.feature_category === 'community') {
        ...
        <Card className="absolute right-0 top-12 w-80 z-50 shadow-lg">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium">Community Notifications</CardTitle>
