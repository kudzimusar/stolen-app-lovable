...
import { Bell, X, CheckCircle, AlertTriangle, Clock, CreditCard, DollarSign } from 'lucide-react'
...
export const PaymentNotificationCenter = () => {
  const { user } = useAuth()
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newNotification.feature_category === 'payment') {
        ...
        <Card className="absolute right-0 top-12 w-80 z-50 shadow-lg">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium">Payment Notifications</CardTitle>
