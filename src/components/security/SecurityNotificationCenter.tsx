...
import { Bell, X, CheckCircle, AlertTriangle, Clock, Shield, Lock } from 'lucide-react'
...
export const SecurityNotificationCenter = () => {
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    // Set up real-time subscription for security notifications
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newNotification.feature_category === 'security') {
