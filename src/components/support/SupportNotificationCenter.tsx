...
import { Bell, X, CheckCircle, AlertTriangle, Clock, HelpCircle, MessageSquare } from 'lucide-react'
...
export const SupportNotificationCenter = () => {
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    // Set up real-time subscription for support notifications
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newNotification.feature_category === 'support') {
        ...
        <Card className="absolute right-0 top-12 w-80 z-50 shadow-lg">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium">Support Notifications</CardTitle>
