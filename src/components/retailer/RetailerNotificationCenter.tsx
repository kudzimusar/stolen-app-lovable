...
import { Bell, X, CheckCircle, AlertTriangle, Clock, Building, Package } from 'lucide-react'
...
export const RetailerNotificationCenter = () => {
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    // Set up real-time subscription for retailer notifications
    const channel = supabase
      .channel('retailer_notifications')
      .on(
        'postgres_changes',
        {
          event: 'INSERT',
        ...
        (payload) => {
          const newNotification = payload.new as RetailerNotification
          if (newNotification.feature_category === 'retailer') {
        ...
        <Card className="absolute right-0 top-12 w-80 z-50 shadow-lg">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium">Retailer Notifications</CardTitle>
