...
import { Bell, X, CheckCircle, AlertTriangle, Clock, Shield, Users, Database } from 'lucide-react'
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newNotification.feature_category === 'admin') {
