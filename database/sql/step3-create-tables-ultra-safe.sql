-- STEP 3: Create new tables (ULTRA-SAFE VERSION)
-- This script creates tables WITHOUT any references to user_notifications columns
...
-- Create notification delivery logs table (WITHOUT foreign key to user_notifications for now)
CREATE TABLE IF NOT EXISTS notification_delivery_logs (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    notification_id UUID, -- Will add foreign key constraint later
