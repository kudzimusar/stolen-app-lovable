-- STEP 3: Create new tables (BULLETPROOF VERSION)
-- This script creates the supporting tables WITHOUT referencing user_notifications columns

-- Create notification preferences table (without complex constraints)
...
-- Add unique constraint separately (after table is created)
